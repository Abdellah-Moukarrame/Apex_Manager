...
class Roaster
{
    ...
    public function displayBypage($page){
       ...
       $page = ($page - 1) * 4;
       //hna jebt players
       $sql_display = $this->db->prepare("select joueur.* , contrat.salaire , contrat.date_fin from joueur left join contrat on contrat.id_joueur = joueur.id_J limit 4 offset $page");
       $sql_display->execute();
